...
for i in range(1,16+1):
	subprocess.call(['./test-6 '+'count_words_c '+str(i)+archivosExp4+'  >> ./resultados/count_words_c_Exp4.csv'],shell = True)

for i in range(1,16+1):
	subprocess.call(['./test-6 '+'count_words_ct '+str(i)+archivosExp4+'  >> ./resultados/count_words_ct_Exp4.csv'],shell = True)

for i in range(1,16+1):
	subprocess.call(['./test-6 '+'maximum '+str(i)+' '+str(i)+archivosExp4+'  >> ./resultados/maximum_Exp4.csv'],shell = True)

for i in range(1,16+1):
	subprocess.call(['./test-6 '+'maximum_cw_c '+str(i)+' '+str(i)+archivosExp4+'  >> ./resultados/maximum_cw_c_Exp4.csv'],shell = True)

for i in range(1,16+1):
	subprocess.call(['./etest-6 '+'maximum_cw_ct '+str(i)+' '+str(i)+archivosExp4+'  >> ./resultados/maximum_cw_ct_Exp4.csv'],shell = True)